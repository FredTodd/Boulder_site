  ...
  const posts = [
    {
      ...
      contentType: 'video', // Content type is video
      contentUrl: 'https://www.youtube.com/embed/PzgOb99i654', // URL for video content
    ...
    },
    {
      ...
      contentType: 'image', // Content type is image
      contentUrl: 'https://img.ukclimbing.com/i/435037?fm=webp&time=1724070115&dpr=2&w=768&sharp=7&s=bb4dfef68a3a7c1234bd7f29955ade5d', // URL for image content
    ...
    },
    {
      ...
      contentType: 'image', // Content type is image
      contentUrl: 'https://gripped.com/wp-content/uploads/2024/08/20240810_9848_JANVIRTA_240ppi-1-scaled.jpg', // URL for image content
    ...
    },
    {
      ...
      contentType: 'image', // Content type is image
      contentUrl: 'https://img.ukclimbing.com/i/435365?fm=webp&time=1724409943&dpr=2&w=1134&sharp=7&s=6f4662d20c9ee318c32a9ef508f5f7a5', // URL for image content
    ...
    },
    {
      ...
      contentType: 'image', // Content type is image
      contentUrl: 'https://img.ukclimbing.com/i/196334?fm=webp&time=1582704776&s=4483ee6238346611c6696b32d7a996d1', // URL for image content
    ...
    },
    {
      ...
      contentType: 'video', // Content type is video
      contentUrl: 'https://www.youtube.com/embed/4SIHNd6kEGY', // URL for video content
    ...
    },
    {
      ...
      contentType: 'image', // Content type is image
      contentUrl: 'https://img.ukclimbing.com/i/434227?fm=webp&time=1723205192&dpr=2&w=1134&sharp=7&s=37f06aae4c2f295e0316d7565fe1479f', // URL for image content
    ...
    },
    {
      ...
      contentType: 'image', // Content type is image
      contentUrl: 'https://www.planetmountain.com/uploads/img/1/130513.jpg', // URL for image content
    ...
    },
    {
      ...
      contentType: 'video', // Content type is video
      contentUrl: 'https://www.youtube.com/embed/x7BwDT4xrhE', // URL for video content
    ...
    },
    {
      ...
      contentType: 'video', // Content type is video
      contentUrl: 'https://www.youtube.com/embed/lVgCdN24xD8', // URL for video content
    ...
    },
    {
      ...
      contentType: 'image', // Content type is image
      contentUrl: 'https://www.planetmountain.com/uploads/img/1/130346.jpg', // URL for image content
    ...
    },
    {
      ...
      contentType: 'video', // Content type is video
      contentUrl: 'https://www.youtube.com/embed/y47TXwLbCu8', // URL for video content
